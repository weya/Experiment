...
sinus3ch = zeros(1,dlzka+nuly_pred+nuly_za);
...
for i=1:dlzka
    ...
    sinus3ch(nuly_pred+i)=pom;
end

% okno
okno = [zeros(1,nuly_pred) (chebwin(length(sinus3ch)-nuly_pred-nuly_za)') zeros(1,nuly_za)];
sinus3ch = sinus3ch.*okno;

% ulozenie matice
save sinus2.mat sinus3ch FVZ frekv;
